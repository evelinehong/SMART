...
class MAthProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["O", "agent", "speed", "time", "distance"]
...
class MAthEventProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["O", "relation", "task", "distance"]
...
class MAthNewProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["O", "event", "task", "relation", "task_distance", "event_distance", "relation_num"]
...
class MAthRelationProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["O", "agent", "relation_num", "quantity"]
...
class MAthPriceProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["O", "agent", "quantity", "rate", "unit"]
