...
data_all = load_raw_data("data/Math_23K_interpretable.json")
data_train = load_raw_data("data/Math_23K_train.json")
data_valid = load_raw_data("data/Math_23K_train.json")
data_test = load_raw_data("data/Math_23K_test.json")
