...
class DataLoader():
    def __init__(self, args, emb_dim=128):
        self.args = args
        self.math23k_train_list = read_data_json("./data/new_train23k_processed.json")
        self.math23k_valid_list = read_data_json("./data/new_valid23k_processed.json")
        self.math23k_test_list = read_data_json("./data/new_test23k_processed.json")
